...
という主観でもって判断をする事で、コンテキストを持って読めるようになるのも良いと思う。
...
こうした内容が好きだがいまいちブランシャール自身の主張はIMFのホワイトペーパーはゴツいのも多くてついていけないなぁ、
...
講義はとって一応単位はとりました、くらいではついていけない気がする。
...
また、そうした議論がきになる向きにちゃんとより進んだ研究へのポインが言及されているので安心感がある。
...
政策的な話だけを取り出して議論するのは、この素晴らしい本に対してあまりにも貧しい姿勢だとは思う。
