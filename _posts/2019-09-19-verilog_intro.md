...
描いてみると、持ち越す必要があるのは実はRegWriteAddressとPCPlus4だけか。
こんな感じか？
...
基本的には3が使っているレジスタが、2か1が書き込む予定のレジスタとかぶっていると横流ししてもらう必要がある。
...
[Tiny SIMDを作ろう](https://karino2.github.io/2019/10/02/tinysimd.html)