...
上記のようなadtのような事を現在の言語機能でどう実現するか、と考えると意味がわからなくなります。
...
その実現したいアイデアはなにか？と言えば、structの延長のなにかで、新しいデータ型を定義するなんらかの方法を作りたい、と考える事です。
...
そもそもにクラスなどの現代的なオブジェクト指向言語の機能はこれらのアイデアを実現する為に使いやすいように作られているので、
見た目がとても似ていて、違いは何なのか？とか考えるのは混乱しやすい上に大してご利益もありません。

F# などのようにADTを手作りしないといけない言語の方がこうした話の重要度は高いし、
また実現したいアイデアと作り方の区別も分かりやすいですね。
