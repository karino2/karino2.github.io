...
一方、ここまでの解説をちゃんと理解出来ていれば、クラスとは別の言語機能で実現する方法も見れば理解出来ると思います。
...
ADTとしても見る事が出来る視点を持つのは良い面もありますが、入門向きでは無いでしょう。

F# などのようにADTを手作りしないといけない上にデータ型の重要度が高い言語の方が、こうした話の重要度は高いし、
また理解もしやすいと思う。
実現したいアイデアと作り方に多少の距離があるので両者の違いに悩む必要も無いし。

型が集合を表すと考えると、集合の性質をそこに適用出来る演算で考えるというのは、代数的構造を考えるのと似た話で、
