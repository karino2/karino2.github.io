...
だがなんか機械学習界隈は言語内DSLで片付けるべき所をYAMLとかに外だししたがる。
YAMLはpoor man's言語外DSLとして使われてると思うが、そのせいでホスト言語の機能が使えなくてかえって不便になっている事は多い。
...
例えば $$ 3 x_2 + a y $$ をpredictするとどうもaが誤認識する、という時に、元のデータセットで、係数が文字の場合もあっただろうか？とこのデータセットを生成しているコードを確認したい、
というのはいかにもありそうな話だ。
